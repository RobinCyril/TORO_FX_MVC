...
import {category_upload,setting, create_category,get_course,
  ...
  ,final_exam,upload_final_exam,get_assistant,get_chapter_edit,
  update_selected_chapter,get_add_chapter} from '../controllers/courseController.js';

  import {get_video,get_library_upload,add_video,get_update_video} from '../controllers/videoController.js'
